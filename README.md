...
| **7** | Testing | 🟠 **Đã đo xong** — **1.001 test thu thập / 1.000 pass / 1 `xfail`** (02/08/2026), bao phủ tầng nghiệp vụ **87,7%**; 🟡 **NFR-P1 chỉ đạt sàn** (p95 **1.143 ms**, sàn 1.500, mục tiêu 800) và ❌ **NFR-P2 trượt sàn** (2,379 FPS, sàn 3) — cùng nguyên nhân là đuôi độ trễ của bậc thang thử-lại, một đánh đổi có chủ ý lấy 34 biển; chốt M7 vẫn bị chặn bởi **NFR-A5/A6** (độ chính xác OCR biển 2 dòng) |
