...
| Độ chính xác E2E (A7) | ≥ 0.88 | ❌ **56,5%** — **đã đo lại trên ảnh toàn cảnh 02/08/2026**, nhãn *"không đại diện"* nay được gỡ ([34](../reports/34-scene-level-a7.md)). Ước lượng phân tầng trên 1.606 khung biển của 1.514 ảnh hiện trường, 385 khung có nhãn chuỗi: tầng dễ 97,3% · tầng khó 44,1%. Con số cũ **0,5552** đo trên ảnh *đã cắt sẵn* nên không đại diện; hai phép đo gần nhau **một cách tình cờ** — chúng đo hai thứ khác nhau trên hai ngữ liệu khác nhau |
