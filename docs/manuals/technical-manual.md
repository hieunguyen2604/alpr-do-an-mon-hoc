...
|---|---|---|
| **NFR-A5 · A6 · A7** — đúng cả chuỗi | ❌ **Không đạt**. Toàn bộ khoảng cách nằm ở **biển hai dòng**; biển một dòng đạt 0,9541, vượt mục tiêu | Quyển, mục 5.5 và Bảng 5.15 |
...
tải, bảo trì — đều **đạt**. Bảng đối chiếu đầy đủ ở Bảng 5.15 của quyển.
