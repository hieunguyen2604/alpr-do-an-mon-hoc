...
- **Đã đo (2.801 biển):** A5 = 0,6098, A6 = 0,6555 ⇒ **hiệu số +4,57 điểm** — **128 biển được sửa đúng, 0 biển bị làm hỏng** ở mức chuỗi. Đóng góp của hậu xử lý là dương và loss-free, đúng như thiết kế; nhưng cả A5 và A6 **đều dưới ngưỡng** vì biển 2 dòng kéo xuống (xem D1).
...
| OCR (2.801 biển) | A4 **0,873** · A5 **0,610** · A6 **0,656** — KHÔNG đạt; A6−A5 = **+4,57 điểm** |
